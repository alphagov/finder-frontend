...
describe "All components" do
  Dir.glob("app/views/components/*.erb").each do |filename|
    ...
    describe component_name do
      ...
      it "has the correct class in the ERB template", skip: component_name.in?(%w[date_filter]) do
      ...
      it "has a correctly named SCSS file", skip: component_name.in?(%w[date_filter]) do
