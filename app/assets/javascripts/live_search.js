...
(function () {
  ...
  function LiveSearch (options) {
    ...
    this.$selectedFacetsCount = this.$form.find('.js-selected-filter-count')
    this.$mobileCountButton = this.$form.find('.js-result-count')
    this.$mobileFacetTagBlock = this.$form.find('#js-facet-tag-block')
  ...
  LiveSearch.prototype.displayResults = function displayResults (results, action) {
    ...
    if (action === $.param(this.state)) {
      ...
      this.updateElement(this.$selectedFacetsCount, results.display_selected_facets_count)
