...
(function () {
  ...
  function LiveSearch (options) {
    ...
    if (GOVUK.support.history()) {
      ...
      var checkboxRadioSelects = this.$form.querySelectorAll('input[type=checkbox], input[type=radio], select')
      for (var c = 0; c < checkboxRadioSelects.length; c++) {
        checkboxRadioSelects[c].addEventListener('change', this.formChange.bind(this))
      }
