...
class Finder
  ...
  attr_reader :slug, :name, :document_noun, :facets, :related, :signup_page_path, :signup_page_text
  ...
  def initialize(attrs = {})
    ...
    @signup_page_path = attrs[:signup_page_path]
    @signup_page_text = attrs[:signup_page_text]
  end
