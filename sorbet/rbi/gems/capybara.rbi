...
module Capybara::Selenium::Node::Html5Drag
  def html5_drag_to(element); end
  def html5_draggable?; end
...
class Capybara::RSpecMatchers::Matchers::HaveSelector < Capybara::RSpecMatchers::Matchers::WrappedElementMatcher
  def description; end
...
class Capybara::RSpecMatchers::Matchers::HaveAncestor < Capybara::RSpecMatchers::Matchers::WrappedElementMatcher
  def description; end
  def element_does_not_match?(el); end
  def element_matches?(el); end
  def query; end
...
class Capybara::RSpecMatchers::Matchers::HaveSibling < Capybara::RSpecMatchers::Matchers::WrappedElementMatcher
  def description; end
  def element_does_not_match?(el); end
  def element_matches?(el); end
  def query; end
...
class Capybara::RSpecMatchers::Matchers::HaveText < Capybara::RSpecMatchers::Matchers::WrappedElementMatcher
  def description; end
  def element_does_not_match?(el); end
  def element_matches?(el); end
